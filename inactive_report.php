...
<html>
<head>
<title>Admin Dashboard | Inactive Employee Report</title>
...
<body>
<div class="container">
<h2>Admin Dashboard - Inactive Employee Report</h2>
...
<option value="">-- Select Inactive Employee --</option>
<?php
$empList = $conn->query("SELECT id, name FROM employees WHERE is_deleted=1 ORDER BY name");
